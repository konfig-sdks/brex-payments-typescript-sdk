...
import { ChequeDetailsRequestAllOf } from './cheque-details-request-all-of';
...
/**
 * @type ChequeDetailsRequest
 * @export
 */
export type ChequeDetailsRequest = ChequeDetailsRequestAllOf & PaymentAccountDetails;
