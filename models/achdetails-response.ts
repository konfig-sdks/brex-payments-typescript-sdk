...
import { ACHDetailsResponseAllOf } from './achdetails-response-all-of';
...
/**
 * @type ACHDetailsResponse
 * @export
 */
export type ACHDetailsResponse = ACHDetailsResponseAllOf & PaymentAccountDetailsResponse;
