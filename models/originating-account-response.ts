...
import { BrexCashAccountDetailsResponse } from './brex-cash-account-details-response';
 ...
 * @export
 */
export type OriginatingAccountResponse = { type: 'BREX_CASH' } & BrexCashAccountDetailsResponse;
