...
/**
 * This class provides a wrapper for network errors when making requests to Payments API
 */
export class BrexPaymentsError extends Error {
  /**
   * The response body
   */
